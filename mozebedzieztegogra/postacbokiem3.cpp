...
void DrawFrame3 (SDL_Renderer* renderer) {
    ...
    DrawRotatedRect(renderer, 337/5 + PX, 320/5 + PRZESUNIECIE, 150/5, 20/5, 80, bodycolor); //reka prawa
    ...
    DrawFilledRectangle(renderer, 250/5 + PX, 520/5 + PRZESUNIECIE, 100/5, 180/5, legscolor); //spodnie
    DrawFilledRectangle(renderer, 240/5 + PX, 700/5 + PRZESUNIECIE, 120/5, 50/5, shoescolor); //buty
    DrawFilledRectangle(renderer, 285/5 + PX, 280/5 + PRZESUNIECIE, 30/5, 10/5, shoescolor); //obroza
    DrawFilledRectangle(renderer, 270/5 + PX, 330/5 + PRZESUNIECIE, 20/5, 150/5, bodycolor); //reka lewa

    // Rysowanie trójk¹tow
    DrawFilledTriangle(renderer, 220/5 + PX, (800 - 520 - 80)/5 + PRZESUNIECIE, 350/5 + PX, (800 - 470 - 80)/5 + PRZESUNIECIE,
        420/5 + PX, (800 - 520 - 80)/5 + PRZESUNIECIE, bodycolor); //broda
    ...
    DrawFilledCircle(renderer, 260/5 + PX, 150/5 + PRZESUNIECIE, 10/5, eyescolor1); //oko lewe
    DrawFilledCircle(renderer, 260/5 + PX, 150/5 + PRZESUNIECIE, 5/5, eyescolor2);
    DrawFilledCircle(renderer, 380/5 + PX, 150/5 + PRZESUNIECIE, 10/5, eyescolor1); //oko prawe
    DrawFilledCircle(renderer, 380/5 + PX, 150/5 + PRZESUNIECIE, 5/5, eyescolor2);
