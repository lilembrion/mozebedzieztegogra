...
void DrawJumpFrame1(SDL_Renderer* renderer) {
	...
	//kopniete prostokaty
	DrawRotatedRect(renderer, 280/5 + PX, 340/5 + PRZESUNIECIE, 150/5, 20/5, 120, bodycolor); //reka lewa ?????????
	DrawRotatedRect(renderer, 337/5 + PX, 320/5 + PRZESUNIECIE, 150/5, 20/5, 60, bodycolor); //reka prawa
	...
	// Rysowanie trójk¹tow
	DrawFilledTriangle(renderer, 200/5 + PX, (800 - 520 - 80)/5 + PRZESUNIECIE, 300/5 + PX, (800 - 470 - 80)/5 + PRZESUNIECIE,
		400/5 + PX, (800 - 520 - 80)/5 + PRZESUNIECIE, bodycolor); //broda
	...
	//kolka
	DrawFilledCircle(renderer, 240/5 + PX, 150/5 + PRZESUNIECIE, 10/5, eyescolor1); //oko lewe
	DrawFilledCircle(renderer, 240/5 + PX, 150/5 + PRZESUNIECIE, 5/5, eyescolor2);
	DrawFilledCircle(renderer, 360/5 + PX, 150/5 + PRZESUNIECIE, 10/5, eyescolor1); //oko prawe
	DrawFilledCircle(renderer, 360/5 + PX, 150/5 + PRZESUNIECIE, 5/5, eyescolor2);
