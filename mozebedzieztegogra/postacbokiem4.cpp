...
void DrawFrame4 (SDL_Renderer * renderer){
    ...
    DrawRotatedRect(renderer, 250/5 + PX, 510/5 + PRZESUNIECIE, 50/5, 190/5, 10, legscolor); //spodnie lewa
    DrawRotatedRect(renderer, 215/5 + PX, 695/5 + PRZESUNIECIE, 60/5, 50/5, 10, shoescolor); //buty
    ...
    DrawRotatedRect(renderer, 270/5 + PX, 330/5 + PRZESUNIECIE, 20/5, 150/5, -20, bodycolor); //reka lewa
